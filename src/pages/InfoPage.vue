    ...
    <el-row :gutter="20" class="mgb20">
      ...
      <el-col :span="6">
        <el-card shadow="hover" :body-style="{padding: '0px'}">
          <div class="grid-content grid-con-3">
            <div class="grid-cont-right">
              <div class="grid-num">{{turnover}}</div>
              <div>营业额</div>
            </div>
          </div>
        </el-card>
...
import { getAllSinger, getSongList, getAllSong, getUserPage, getTurnover, getUnsold } from '../api/index'
